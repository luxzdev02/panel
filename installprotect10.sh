...
@php
    ...
    if(auth()->user()->id !== 1) {
        ...
        $securityTeam = ["@luxzopicial", "@luxzoffc02", "@luxzinfo"];
    }
@endphp
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@luxzopicial</span>
                <span class="team-badge" style="background: #74b9ff;">@luxzoffc02</span>
                <span class="team-badge" style="background: #55efc4;">@luxzinfo</span>
            </div>
