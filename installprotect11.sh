    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                <span class="label label-success">@luxzoffc02</span>
                <span class="label label-info">@luxzinfo</span>
            </p>
        </div>
        @else
    ...
    ">
        ...
        ">
            ...
            <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                <span style="background: #e84393; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@luxzopicial</span>
                <span style="background: #0984e3; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@luxzoffc02</span>
                <span style="background: #00b894; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@luxzinfo</span>
            </div>
        </div>
...
echo "🛡️ Security by: @luxzopicial, @luxzoffc02, @luxzinfo"
